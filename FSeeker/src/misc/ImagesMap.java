...
@param d la dimension voulue
@return l'image à la dimension voulue ou l'image par défaut si l'image n'existe pas, ou null si celle-ci n'existe pas non plus.*/
    public static Icon get(String image, Dimension d) {
	final String prefix = "#" + d.toString() + "#";
     ...
     * @param file
     *            le fichier
@param d la dimension désirée de l'icône retourné
     * @return l'icône
     */
